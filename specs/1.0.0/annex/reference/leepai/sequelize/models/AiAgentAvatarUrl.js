...
/**
 * AiAgentAvatarUrl model
 *
 * @class AiAgentAvatarUrl
 * @extends {BaseAppRenchanModel}
 */
export default class AiAgentAvatarUrl extends BaseAppRenchanModel {
  /**
   ...
   *
   * @returns {typeof import('./AiAgentAvatarUrlBk.js').default} Backup model declaration
   */
  static get BackupModel () {
    return this._.AiAgentAvatarUrlBk
  }
}
