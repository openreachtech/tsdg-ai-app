...
/**
 * AiAgentDocumentInstructionRecord model
 *
 * @class AiAgentDocumentInstructionRecord
 * @extends {BaseAppRenchanModel}
 */
export default class AiAgentDocumentInstructionRecord extends BaseAppRenchanModel {
  /**
