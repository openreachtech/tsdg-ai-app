...
export default class ClaudeSonnet4AiModelProcessor extends BaseClaudeAIProcessor {
  /**
   * Factory method to create a Claude Sonnet 4 processor
   *
   * @returns {ClaudeSonnet4AiModelProcessor}
   */
  static create () {
    return new this()
  }
   ...
   */
  get aiModel () {
    return AI_MODEL.CLAUDE_SONNET_4.NAME
  }
  ...
  /**
   * Create ClaudeMessagePayloadGenerator
   *
   * @param {{
   *   aiAgent: model.AiAgentWithAssociationsEntity
