...
export default class ClaudeOpus4_1AiModelProcessor extends BaseClaudeAIProcessor {
  /**
   * Factory method to create a Claude Opus 4 ai model processor
   *
   * @returns {ClaudeOpus4_1AiModelProcessor}
   */
  static create () {
    return new this()
  }
   ...
   */
  get aiModel () {
    return AI_MODEL.CLAUDE_OPUS_4_1.NAME
  }
