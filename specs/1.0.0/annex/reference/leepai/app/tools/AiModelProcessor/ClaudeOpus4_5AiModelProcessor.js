...
export default class ClaudeOpus4_5AiModelProcessor extends BaseClaudeAIProcessor {
  /**
   * Factory method to create a Claude Opus 4.5 ai model processor
   *
   * @returns {ClaudeOpus4_5AiModelProcessor}
   */
  static create () {
    return new this()
  }
   ...
   */
  get aiModel () {
    return AI_MODEL.CLAUDE_OPUS_4_5.NAME
  }
