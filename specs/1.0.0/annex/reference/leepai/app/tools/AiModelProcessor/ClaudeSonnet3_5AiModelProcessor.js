...
export default class ClaudeSonnet3_5AiModelProcessor extends BaseClaudeAIProcessor {
  /**
   * Get AI model
   *
   * @returns {string}
   */
  get aiModel () {
    return AI_MODEL.CLAUDE_SONNET_3_5.NAME
  }
  ...
  /**
   * Create Claude message payload generator
   *
   * @param {{
   *   aiAgent: model.AiAgentWithAssociationsEntity
